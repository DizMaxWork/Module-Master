  ...
  return (
    <>
      <section
        ...
        id="main"
      >
        <h1 className="md:text-5xl text-4xl font-bold md:w-3/5 pb-7 lg:leading-[65px] xl:mt-8 lg:mt-10 md:mt-4 md:leading-[55px] leading-[50px]">
          {mainBlock.title}
        </h1>
      ...
      <SmallMainBlock mainBlock={mainBlock} data={data} />
    </>
  );
};
